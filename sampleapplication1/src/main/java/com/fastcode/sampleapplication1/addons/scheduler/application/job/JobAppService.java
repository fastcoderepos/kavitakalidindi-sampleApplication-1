package com.fastcode.sampleapplication1.addons.scheduler.application.job;

import com.fastcode.sampleapplication1.Sampleapplication1Application;
import com.fastcode.sampleapplication1.addons.scheduler.CGenClassLoader;
import com.fastcode.sampleapplication1.addons.scheduler.application.job.dto.*;
import com.fastcode.sampleapplication1.addons.scheduler.constants.QuartzConstants;
import com.fastcode.sampleapplication1.addons.scheduler.domain.job.IJobRepository;
import com.fastcode.sampleapplication1.addons.scheduler.domain.job.JobEntity;
import com.fastcode.sampleapplication1.addons.scheduler.domain.job.QJobEntity;
import com.fastcode.sampleapplication1.addons.scheduler.domain.jobhistory.IJobHistoryRepository;
import com.fastcode.sampleapplication1.addons.scheduler.domain.jobhistory.JobHistoryEntity;
import com.fastcode.sampleapplication1.addons.scheduler.domain.jobhistory.QJobHistoryEntity;
...
public class JobAppService implements IJobAppService {
    ...
    public List<String> listAllJobClasses() throws URISyntaxException {
        ...
        URI uri = Sampleapplication1Application.class.getResource("/").toURI();
